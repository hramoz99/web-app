      ...
      <Carousel className="carousel" activeIndex={index} onSelect={handleSelect}>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption className="h3-carousel">
            ...
            <p>Venha nos conhecer! Ficamos perto do Shopping Morumbi!</p>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
      <div id="sobre" className="sobre">
        ...
        <div className="sobre-1">
          ...
          <div className="sobre-p">
            <p>
              Criada em 2012 por Muriel Martins e Gustavo Mainchein e com a soma de seus talentos com a sua paixão por veículos decidiram criar a DaRede Funilaria. Esta empresa tem o objetivo de misturar a valocidade e baixo custo com a qualidade extrema nos serviços prestados aos clientes, que é nossa maior prioridade.
            </p>
          </div>
        </div>
        <div className="sobre-2">
          ...
          <div className="sobre-p">
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris massa turpis, luctus eget auctor ac, vulputate eu ligula. Morbi eu turpis arcu. Aenean varius risus eget lacus mattis, a pharetra lacus sagittis. Phasellus fringilla metus sit amet eleifend blandit. Suspendisse potenti.
            </p>
          </div>
        </div>
        </div>
